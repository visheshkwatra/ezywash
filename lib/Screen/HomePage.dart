...
class _HomePageState extends State<HomePage> {
  ...
  void getCurrentLocation() async {
    /// To check that Location Access Permission is granted or not
    var status = await Permission.locationWhenInUse.request();
    print(status);
    if (status.isGranted) {
      /// If location Access is Granted then fetch the Customer Location.
      ...
      /// if Location Access is permanently denied then we provide it with static latitude and longitude.
      _center = LatLng(28.6139, 77.2090);
    } else {
  ...
  static LatLng _center = LatLng(28.6139, 77.2090);
              ...
              children: <Widget>[
                ...
                SelectedInformation.customerID != null
                    ? Container(
                        ...
                        child: Center(
                          child: Text(
                            '${SelectedInformation.customerName[0].toUpperCase()}', // for First Alphabet in Profile Pic
                            style: TextStyle(
                                fontSize: 48,
                                fontWeight: FontWeight.bold,
                                color:
                ...
                sliderItem('Term & Conditions', Icons.pending_actions_outlined,
                    () {
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            pref.clear();
                            SelectedInformation.customerPhoneNumber = null;
                            SelectedInformation.customerEmail = null;
                            SelectedInformation.customerName = null;
                            SelectedInformation.customerID = null;
                            SelectedInformation.customerAddress = null;
                                              ...
                                              children: [
                                                ...
                                                Categories
                                                    ...
                                                    ? Padding(
                                                        ...
                                                        child: GradientText(
                                                          text:
                                                              '${Categories.selectedCategories[index].name}',
                                                          gradient:
                                                              LinearGradient(
                                                                  colors: [
                                                                Colors
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ListTile(
                                                            ...
                                                            title: Text(
                                                                '${Products.selectedProducts[index].name}',
                                                                style: TextStyle(
                                                                    color: Theme.of(
                                                                            context)
                                                                        .colorScheme
                                                            ...
                                                            subtitle: Row(
                                                              children: [
                                                                Text(
                                                                  '${Products.selectedProducts[index].sellingPrice}',
                                                                  style: TextStyle(
                                                                      color: Theme.of(
                                                                              context)
                                                                          .colorScheme
                                                                ...
                                                                Text(
                                                                  '${Products.selectedProducts[index].discountPrice}',
                                                                  style: TextStyle(
                                                                      color: Theme.of(
                                                                              context)
                                                                          .colorScheme
                                                        ...
                                                        ExpansionTile(
                                                          ...
                                                          children: [
                                                            Text(
                                                              '${Products.selectedProducts[index].description}',
                                                              style: TextStyle(
                                                                fontSize: 16,
                                                                color: Theme.of(
                                                                        context)
